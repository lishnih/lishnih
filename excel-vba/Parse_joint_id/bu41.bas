...
'       .Global = True
    ...
    type_ptrn = "(АХ|АС|РД)(?:\(.\))?"
    kp_ptrn = "км[ \.]*(\d+)"
    joint_id_ptrn = "ст" & separator_ext_ptrn & "(\d+)" & separator_ptrn & "([АБВГДЕКЛЗРL]*)"
    joint_id_ext_ptrn = "ст" & separator_ext_ptrn & "([\d-]+)" & separator_ptrn & "([АБВГДЕКЛЗРL]*(?:\/\d)?)"

' АХ ст-84 км 688           Частный случай: АХ ст.1-8 км.724
' РД(И) ст 82р км657        Частный случай: РД(И) ст-65К/1 км679
